          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-[11px] text-slate-400">
                Tiga parfum populer dengan karakter berbeda yang cocok untuk dijadikan referensi awal.
              </p>
            </div>
            <button
              onClick={() => onSelectPerfume && onSelectPerfume(featuredPerfumes[0])}
          ...
          <div className="grid md:grid-cols-3 gap-4 text-xs">
            {latestNews.map((n) => (
              ...
              >
                ...
                <button
                  onClick={() => onSelectNews && onSelectNews(n)}
